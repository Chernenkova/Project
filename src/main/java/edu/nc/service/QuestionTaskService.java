...
public class QuestionTaskService {
    ...
    public ResponseEntity addTask(CreateQuestionTaskWrapper wrapper, String type) {
        ...
        byte[] taskBytes = JsonClassParser.getInstance().getBytes(questionTaskWrapper);
        ...
        byte[] answerBytes = JsonClassParser.getInstance().getBytes(new QuestionTaskAnswerWrapper(qaArray));
    ...
    public ResponseEntity<QuestionTaskWrapper> get(Long id) {
        ...
        if (GeneralSettings.QUESTION_TASK_TYPE.equals(entity.getType()) ||
            ...
            QuestionTaskWrapper task = JsonClassParser.getInstance().getObject(entity.getTask(), QuestionTaskWrapper.class);
            addToDbInfoStart(id);
    ...
    public ResponseEntity<QuestionResult> check(Long id, QuestionTaskAnswerWrapper wrapper) {
        ...
        if (!(GeneralSettings.QUESTION_TASK_TYPE.equalsIgnoreCase(entity.getType())
                || GeneralSettings.GRAMMAR_TASK_TYPE.equalsIgnoreCase(entity.getType()))) {
            return new ResponseEntity<>(HttpStatus.BAD_REQUEST);
        }

        QuestionTaskAnswerWrapper correct = JsonClassParser.getInstance().getObject(entity.getAnswer(), QuestionTaskAnswerWrapper.class);
    ...
    public ResponseEntity<QuestionResult> checkVideo(Long id, QuestionTaskAnswerWrapper wrapper) {
        ...
        if (!GeneralSettings.VIDEO_TASK_TYPE.equalsIgnoreCase(entity.getType())) {
            return new ResponseEntity<>(HttpStatus.BAD_REQUEST);
        }
    ...
    private User addToDbInfoCheck(Long id, int totalScore, int score) {
        ...
        if (TaskProgressStatus.FIRST == tpe.getStatus()) {
    ...
    private TaskProgressEntity addToDbInfoStart(Long id) {
        ...
        QuestionTaskAnswerWrapper c1 = JsonClassParser.getInstance().getObject(task.getAnswer(),
